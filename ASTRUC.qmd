...
climate |>
  ...
  summarise(num_climate = n_distinct(climate_type)) |>
  ggplot(aes(x = planet_identifier, y = num_climate)) +
  geom_point() +
...
terrain |>
  group_by(planet_identifier) |>
  summarise(num_terrain = n_distinct(type_of_terrain)) |>
  ggplot(aes(x = planet_identifier, y = num_terrain)) +
  geom_point() +
  xlab("Planet identifier") +
